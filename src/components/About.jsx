      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-200 to-blue-300 px-4 py-16 flex items-center justify-center">
        <div className="relative z-10 text-center">
          <h2 className="text-6xl flex flex-col items-center">
            {/* <span className="font-semibold bg-gradient-to-br from-blue-300 to-blue-600 bg-clip-text text-transparent animate-pulse leading-[1.5] text-3xl sm:text-5xl"> */}
            <span className="font-semibold text-black text-3xl sm:text-5xl">
              Kotchakorn Tantrakool
            </span>

            <p className="text-base sm:text-2xl mt-4 text-black">
